...
try:
    instr_screen_1 = visual.SimpleImageStim(exp_win, image='%s/%s/Detect_Digits_I1_%s.png'%(PATH, LANGUAGE, LANGUAGE))
    instr_screen_2 = visual.SimpleImageStim(exp_win, image='%s/%s/Detect_Digits_I2_%s.png'%(PATH, LANGUAGE, LANGUAGE))
